# Generated by Django 3.0.1 on 2020-01-01 19:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_title', models.CharField(max_length=200, verbose_name='Name of the Article')),
                ('article_text', models.TextField(verbose_name='Text of the Article')),
                ('publishing_date', models.DateTimeField(verbose_name='Date of the Publishing')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
